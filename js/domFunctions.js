...
export const updateDisplay = (weatherJson, locationObj) => {
  ...
  // current conditions
  const ccArray = createCurrentCondionsDivs(weatherJson, locationObj.getUnit());
  displayCurrentConditons(ccArray);
  // six day forecast
...
const createCurrentCondionsDivs = (weatherObj, unit) => {
  const tempUnit = unit === 'imperial' ? 'F' : 'C';
...
const displayCurrentConditons = (currentConditionsArray) => {
